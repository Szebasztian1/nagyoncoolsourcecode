...
--RegisterCommand('anyad', function(s, a, r)
...
AddEventHandler('introCinematic:start', function()
    ...
    TriggerEvent('action_bar_show', false)
    ExecuteCommand("togid")
    ...
    StartCutscene(0) --- START the custscene
    ...
    Wait(1000)
    SetEntityCoords(PlayerPedId(), -538.9302, -214.0114, 37.649787, false, false, false, true)--vector3(-538.9302, -214.0114, 37.649787)
    Wait(800)
    DoScreenFadeIn(1000)
    TriggerEvent('hideHud', false)
    TriggerEvent('action_bar_show', true)
    ExecuteCommand("togid")
    --TriggerEvent('starttutorial')
end) 
