...
Config.ControlStayOnExit       = true -- true = drone stays parked at its position when the player exits FPV control; false = drone resumes following the player (default)
...
Config.DroneDeadModel          =
'ch_prop_casino_drone_broken01a'                               -- prop when battery removed (could just use same as xs_prop_arena_drone_02 so it looks the same)
...
Config.TargetJobOptions = {
    ...
    nzkfc_drone_guard   = { 'asdasd212312' },  -- Guard Mode
    nzkfc_drone_heal    = { 'asdasd212312' },             -- Activate Healing
    nzkfc_drone_control = false,             -- Take Control (FPV)
