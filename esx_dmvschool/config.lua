...
Config.CheckPoints = {

	{
		...
		Action = function(playerPed, vehicle, setCurrentZoneType)
			DrawMissionText(_U('next_point_speed', Config.SpeedLimits['residence']-1), 5000)
		end
	},
...

	{
		...
		Action = function(playerPed, vehicle, setCurrentZoneType)
			...
			Citizen.CreateThread(function()
				DrawMissionText(_U('stop_look_left', Config.SpeedLimits['town']-1), 5000)
				PlaySound(-1, 'RACE_PLACED', 'HUD_AWARDS', false, 0, true)
				FreezeEntityPosition(vehicle, true)
				Citizen.Wait(6000)
...

	{
		...
		Action = function(playerPed, vehicle, setCurrentZoneType)
			...
			DrawMissionText(_U('hway_time', Config.SpeedLimits['freeway']-1), 5000)
			PlaySound(-1, 'RACE_PLACED', 'HUD_AWARDS', false, 0, true)
		end
	},
...

	{
		...
		Action = function(playerPed, vehicle, setCurrentZoneType)
			setCurrentZoneType('town')
			DrawMissionText(_U('in_town_speed', Config.SpeedLimits['town']-1), 5000)
		end
	},
