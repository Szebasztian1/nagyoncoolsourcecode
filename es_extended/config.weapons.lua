...
Config.Weapons = {
    ...
    {
        name = 'WEAPON_USW_CROSSFIREX',
        label = 'USW-CROSSFIREX',
        ammo = { label = _U('ammo_rounds'), hash = `AMMO_PISTOL` },
        components = {
            { name = 'clip_default', label = 'Mag1', hash = `did_usw_crossfirex_mag1` },
            { name = 'suppressor', label = 'Supp', hash = `did_usw_crossfirex_supp` },
        }
    },
	-- Heavy / Launchers
