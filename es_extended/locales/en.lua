Locales['en'] = {
  ...
  -- Salary related
  ['received_salary'] = 'Munkahelyi fizetés: $%s',
  ['received_help'] = 'Kifizették a jóléti csekket:  $%s',
  ['company_nomoney'] = 'A cég, ahol dolgozik, túl szegény ahhoz, hogy kifizesse a fizetését  ',
  ['received_paycheck'] = 'Kapott fizetést  ',
  ['bank'] = 'Segély Bank',
  ['account_bank'] = 'Bank',
