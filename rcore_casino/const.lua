...
CasinoAreas = {
 ...
 [15] = { min = vector3(-3881.217041, 1042.637329, -47.188461), max = vector3(-3792.438721, 1104.057617, -32.635532) }
}
...
PokerTableDatas[0] = {
    ...
    MaxBetValueAntePlay = 35000,
    MinBetValuePairPlus = 10,
    MaxBetValuePairPlus = 30500,
...
PokerTableDatas[2] = {
    ...
    PlaceBetsTime = 15,
    MinBetValueAntePlay = 10,
    MaxBetValueAntePlay = 30500,
    MinBetValuePairPlus = 10,
    MaxBetValuePairPlus = 30050,
    UnluckyRound = 3 -- each 3rd round will be unlucky (high possibility that players get useless cards)
}
...
RouletteTableDatas[0] = {
    ...
    MaxBets = 10,
    MinBetValue = 10,
    MaxBetValue = 40000000,
    MaxBetValueOutside = 60000000,
    MaxBetValueInside = 30000000,
    PlaceBetsTime = 40,
    SpinDelayMin = 5,
    SpinDelayMax = 12,
    UnluckyRound = 4, -- each 4th round spins to the unluckiest number and costs casino the least
    TriggerUnluckyRoundFrom = 10000000 -- always switch to unluckiest number if the spun number costs casino more than this
}
