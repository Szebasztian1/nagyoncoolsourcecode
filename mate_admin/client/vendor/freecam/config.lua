local CTRL_MOUSE_LR      = 1   -- INPUT_LOOK_LR
local CTRL_MOUSE_UD      = 2   -- INPUT_LOOK_UD
local CTRL_SLOW          = 19  -- INPUT_CHARACTER_WHEEL
local CTRL_FAST          = 21  -- INPUT_SPRINT
local CTRL_GO_UP         = 152 -- INPUT_PARACHUTE_BRAKE_LEFT
local CTRL_GO_DOWN       = 153 -- INPUT_PARACHUTE_BRAKE_RIGHT
local CTRL_FRONT_BACK    = 31  -- INPUT_MOVE_UD
local CTRL_LEFT_RIGHT    = 30  -- INPUT_MOVE_LR

local CTRL_RIGHT_TRIGGER = 71 -- INPUT_VEH_ACCELERATE
local CTRL_LEFT_TRIGGER  = 72 -- INPUT_VEH_BRAKE
