...
--
    ...
    --TriggerEvent("esx:showNotification", (data.title and data.title.." - " or "")..(data.description or ""))
    TriggerEvent("bc:notify", (data.title and data.title or ""), (data.description or ""), (data.duration or 5000), "info", false)
end
