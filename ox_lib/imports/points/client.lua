...
CreateThread(function()
    while true do
        ...
        for i = 1, #newPoints do
            ...
            -- No Wait() here: nearbyPoints was wiped above, and a yield would let the
            -- per-frame tick run on a half-rebuilt list, so every marker drawn from
            -- `nearby` blinks (2026-09-14, farmhouse entrance). The loop itself is cheap.
        end
